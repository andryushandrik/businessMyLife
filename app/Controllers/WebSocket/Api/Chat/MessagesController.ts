...
export default class MessagesController {
  ...
  public static async createWithoutTopic(payload: any, createPayload: MessageCreateWithoutTopicPayload, cb: (response: Err | ResponseService) => void): Promise<ReturnMessageCreatePayload | void> {
    let validatedPayload: MessageWithoutTopicValidator['schema']['props']
  ...
  public static async createWithOfferTopic(payload: any, createPayload: MessageCreateWithoutTopicPayload, cb: (response: Err | ResponseService) => void): Promise<ReturnMessageCreatePayload | void> {
