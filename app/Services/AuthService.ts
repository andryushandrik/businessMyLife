...
export default class AuthService {
	...
	public static async emailVerify(
		...
		try {
			...
			if (isForForgotPassword) await MailerService.sendForgotPasswordVerificationCode(email, code)
			else await MailerService.sendRegisterVerificationCode(email, code)
		} catch (err: Err | any) {
			throw err
		}
	}
