...
export default class PromoCodeService {
  public static async paginate(config: PaginateConfig<PromoCode>, filter?: PromoCodeFilterValidator['schema']['props']): Promise<ModelPaginatorContract<PromoCode>> {
  ...
  private static filter(query: ModelQueryBuilderContract<typeof PromoCode>, payload: PromoCodeFilterValidator['schema']['props']): ModelQueryBuilderContract<typeof PromoCode> {
