...
import {
  getOfferCategoryRules, getOfferImageOptions,
  getOfferPaybackTimeRules, getOfferProjectStageRules
} from '../Rules/Offer/offer'
import {
  OFFER_ABOUT_COMPANY_MAX_LENGTH, OFFER_ABOUT_COMPANY_MIN_LENGTH,
  OFFER_ABOUT_MAX_LENGTH, OFFER_ABOUT_MIN_LENGTH,
  OFFER_BENEFITS_MAX_LENGTH, OFFER_BENEFITS_MIN_LENGTH,
  OFFER_BUSINESS_PLAN_MAX_LENGTH, OFFER_BUSINESS_PLAN_MIN_LENGTH,
  OFFER_COOPERATION_TERMS_MAX_LENGTH, OFFER_COOPERATION_TERMS_MIN_LENGTH,
  OFFER_DESCRIPTION_MAX_LENGTH, OFFER_DESCRIPTION_MIN_LENGTH,
  OFFER_TITLE_MAX_LENGTH, OFFER_TITLE_MIN_LENGTH,
