...
import { MAIN_PAGE_VIDEO_DESCRIPTION_MAX_LENGTH, MAIN_PAGE_VIDEO_TITLE_MAX_LENGTH } from 'Config/database'
...
export function getMainPageVideoDescriptionRules(): Rule[] {
	return [rules.maxLength(MAIN_PAGE_VIDEO_DESCRIPTION_MAX_LENGTH)]
}
