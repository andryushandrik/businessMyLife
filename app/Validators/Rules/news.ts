...
import {
  NEWS_DESCRIPTION_MAX_LENGTH, NEWS_TITLE_MAX_LENGTH, NEWS_SUPTITLE_MAX_LENGTH,
  NEWS_TITLE_MIN_LENGTH, NEWS_DESCRIPTION_MIN_LENGTH, NEWS_SUPTITLE_MIN_LENGTH
...
export function getNewsTitleRules(): Rule[] {
  return [
    rules.minLength(NEWS_TITLE_MIN_LENGTH),
...
export function getNewsSuptitleRules(): Rule[] {
  return [
    rules.minLength(NEWS_SUPTITLE_MIN_LENGTH),
